...
def main():
    ...
    benchmarks = {
        "metrics": (f"{args.input_dir}/evaluation-tables.json", create_metrics_benchmark, extract_model_info, 'metrics_response'),
        "abstract": (f"{args.input_dir}/papers-with-abstracts.json", create_abstract_benchmark, None, 'abstract'),
        "model_description": (f"{args.input_dir}/methods.json", create_model_description_benchmark, None, 'description'),
        "research_area": (f"{args.input_dir}/methods.json", create_research_area_benchmark, None, 'area'),
        "odd_man_out": (f"{args.input_dir}/methods.json", create_odd_man_out_benchmark, None, 'Outlier Model'),
        "similar_models": (f"{args.input_dir}/evaluation-tables.json", create_similar_models_benchmark, extract_model_info, 'model_name'),
        "top_models": (f"{args.input_dir}/evaluation-tables.json", create_top_models_benchmark, extract_model_info, 'model_name'),
        "dataset_description": (f"{args.input_dir}/datasets.json", create_dataset_description_benchmark, None, 'description'),
        "modality": (f"{args.input_dir}/datasets.json", create_modality_benchmark, None, 'modalities'),
    }

    for name, (input_file, create_func, preprocess_func, response_column) in benchmarks.items():
        ...
        try:
            ...
            save_benchmark(df, output_file, response_column)
